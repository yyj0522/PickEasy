...
### 13. AI 개발 도구 활용 여부
* 전체 프로젝트의 기획 고도화 및 코드 리팩토링 과정에서 ChatGPT와 Gemini, github copilot을 활용해 아이디에이션을 진행했습니다.
* Gemini를 메인 개발 환경으로 사용하여, Next.js 보일러플레이트 작성, 컴포넌트 분리, 그리고 Supabase DB 스키마 설계 과정에서 AI의 자동 완성 및 코드 리뷰 기능을 적극 활용해 개발 생산성을 끌어올렸습니다.
